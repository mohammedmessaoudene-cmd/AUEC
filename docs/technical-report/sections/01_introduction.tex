...
\begin{enumerate}
  ...
  \item \textbf{A falsifiable conformance study.} Unchanged official MCP runners are paired with four causal negative controls. Incomplete A2A results remain visible rather than being relabeled as expected failures.
\end{enumerate}
