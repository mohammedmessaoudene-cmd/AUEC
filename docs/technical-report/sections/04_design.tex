...
Version 0.36.0 includes a pure executable form of this predicate. It returns an authorization decision and reason codes but has no effect-dispatch interface. This separates evidence about the decision rule from any claim about production action execution.
